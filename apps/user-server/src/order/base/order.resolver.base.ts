...
export class OrderResolverBase {
  ...
  async createOrder(@graphql.Args() args: CreateOrderArgs): Promise<Order> {
    return await this.service.createOrder({
      ...
      data: {
        ...
        isAdmins: args.data.isAdmins
          ? {
              connect: args.data.isAdmins,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => IsAdmin, {
    nullable: true,
    name: "isAdmins",
  })
  async getIsAdmins(@graphql.Parent() parent: Order): Promise<IsAdmin | null> {
    const result = await this.service.getIsAdmins(parent.id);
  ...
  async getUser(@graphql.Parent() parent: Order): Promise<IsAdmin | null> {
